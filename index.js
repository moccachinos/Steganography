...
function encodeMessage() {
  ...
  // cek apakah gambar yang di input cukup besar untuk menutupi pesan
  ...
  // Normalisasi gambar asli dan tampilkan kembali
  ...
  for (i = 0; i < text.length; i++) {
    ...
    // Tambahkan 0 hingga binaryChar memiliki panjang 8 (1 Byte)
  ...
  // Aplikasikan string biner kepada gambar dan ditampilkan kembali
